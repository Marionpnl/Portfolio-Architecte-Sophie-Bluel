...
function openModal (view) {
    try {
        ...
        console.error("Erreur dans openModal:", error);
    }
}
...
function backToGalleryView() {
    try {
        ...
        console.error("Erreur dans backToGalleryView:", error);
    }
}
...
function trapFocus(modal){
    try {
        ...
        console.error("Erreur dans trapFocus:", error);
    }
}
...
export function initModal() {
    try {
        ...
        console.error("Erreur dans initModal:", error);
    }
}
